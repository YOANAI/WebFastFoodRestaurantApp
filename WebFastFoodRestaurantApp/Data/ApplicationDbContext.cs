...
namespace WebFastFoodRestaurantApp.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<WebFastFoodRestaurantApp.Models.Product.ProductDetailsVM> ProductDetailsVM { get; set; }
        public DbSet<WebFastFoodRestaurantApp.Models.Product.ProductDeleteVM> ProductDeleteVM { get; set; }
